# Assignment1
Phase 1 of Software Frameworks assignment

## Git
### Git Layout
This git repository has all the project files for Phase 1 of Assignment 1 as well as this README.md file. The *master* is the default branch where all the majority of the work is done.
### Version Control Approach
The approach taken whilst developing this project was by initially creating the Assignment1 repository and then cloning it onto desktop. 
...
## Sockets, MongoDB and more will be implemented in phase 2. Some of the design used in this phase may change.
